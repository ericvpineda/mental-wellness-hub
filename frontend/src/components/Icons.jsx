export const Icons = {
  write: () => (
    ...
    >
      ...
      <rect
        ...
        width="4.25"
        height="14.84"
        transform="translate(4.32 29.89) rotate(-44.98)"
        fill="#ec5044"
      />
      <path
        d="M29.26,26.4l-7.67-7.68a2,2,0,0,0-3.35,1.06l-1.64,9.32a2,2,0,0,0,2.29,2.29l9.32-1.65A2,2,0,0,0,29.26,26.4Z"
        fill="#edcabb"
      />
      <path
  ...
  magnifyGlass: () => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className="absolute inset-y-0 my-auto h-12 w-12 px-3.5 z-10 stroke-gray-500"
      fill="none"
      viewBox="0 0 24 24"
      stroke="currentColor"
      stroke-width="2"
